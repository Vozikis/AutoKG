...
from intelligraphs.verifier.synthetic import SynTypesVerifier



CHECKPOINT = "syn_types.pt"  
RESUME     = True        
...
(train_g, val_g, test_g,
 (e2i, i2e), (r2i, i2r), *_ ) = load_data_as_list("syn-types")
